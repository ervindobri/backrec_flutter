...
class _PlaybackScreenState extends State<PlaybackScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final double leftPadding = notchPadding.left > 0.0 ? notchPadding.left : 20;
    final double rightPadding =
        notchPadding.right > 0.0 ? notchPadding.right : 20;
    return Scaffold(
      ...
      builder: (context, state) {
        ...
        if (state is PlaybackInitialized ||
          ...
          return Center(
              child: CircularProgressIndicator(color: GlobalColors.primaryRed));
        }
      },
    ));
  }
